        ...
        <section>
          <div className="container">
            ...
            <nav className="atualizar_e_consultar">
              <a className="btn_atualizar" href="#">
                Atualizar
              </a>
              <a
                className="btn_consultar"
                href="../projeto_consulta/projeto_consulta.html"
              >
                Consultar
              </a>
            </nav>
            ...
            <div className="link_button">
              ...
              <div className="btn_links">
                <button>
                  <img src="../assets/images/btn_confirmar.svg" alt="confirmar" />
                </button>
                <button>
                  <img src="../assets/images/btn_cancelar.svg" alt="cancelar" />
                </button>
              </div>
            </div>
          </div>
